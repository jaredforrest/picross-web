...
/* harmony import */ var core_js_modules_es_array_reduce_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(5827);
...
/* harmony import */ var core_js_modules_es_array_iterator_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(6992);
...
/* harmony import */ var core_js_modules_web_url_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(285);
...
/* harmony import */ var core_js_modules_web_url_search_params_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(1637);
...
/* harmony import */ var core_js_modules_es_json_stringify_js__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(8862);
...
function fetch(url, options) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    for (var _i in options.headers) {
      request.setRequestHeader(_i, options.headers[_i]);
    }
...
function n(t, e) {
  ...
  for (var _i2 = 0, _u = t.length; _i2 < _u; _i2++) {
    var _u2 = t[_i2],
      _o = e[_i2];
    if (_u2 instanceof Array) {
      if (!n(_u2, _o)) return !1;
    } else if (_u2 != _o) return !1;
  }
  return !0;
}
function i(t, e) {
...
function u(t) {
  var e = [],
    n = t.reduce(function (t, n) {
      return 1 == n ? t + 1 : (e.push(t), 0);
    }, 0);
  return e.push(n), e.filter(function (t) {
    return 0 != t;
  });
}
function o(t, e) {
  t.textContent = "", e.forEach(function (e) {
    var n = document.createElement("tr");
    e.forEach(function (t) {
      var e = document.createElement("td");
      if (t) {
        var _n = document.createTextNode("" + t);
        e.appendChild(_n);
      }
      n.appendChild(e);
    }), t.appendChild(n);
...
function r(n, i, u, r, c) {
  var l;
  o(i, e(n, c ? (u.length + 3) / 2 | 0 : t(n) + 1)), o(r, (l = e(u, c ? (n.length + 3) / 2 | 0 : t(u) + 1))[0].map(function (t, e) {
    return l.map(function (t) {
      return t[e];
    });
  }));
}
var c = new URL(document.location.origin);
var l = /*#__PURE__*/function () {
  var _proto = l.prototype;
  _proto.t = function t() {
    var t, e, n, o, r;
    return [(t = this.i, e = this.u, i(this.o, function (n, i) {
      return u(t.slice(i * e, i * e + e));
    })), (n = this.i, o = this.u, r = this.o, i(o, function (t, e) {
      return u(i(r, function (t, i) {
        return n[i * o + e];
      }));
    }))];
  };
  function l(t, e) {
    this.u = t, this.o = e, this.i = i(t * e, function () {
      return 0;
    });
  }
  return l;
...
var s = /*#__PURE__*/function () {
  ...
  _proto2.l = function l(t, e) {
    var n = t * this.h.u + e;
    {
      var _t = function (t) {
        return 0 == t ? 1 : 0;
      }(this.h.i[n]);
      this.h.i[n] = _t, 0 == _t ? this.m[n].classList.replace("f", "e") : this.m[n].classList.replace("e", "f");
    }
  };
  _proto2.g = function g() {
    var _this$h$t = this.h.t(),
      t = _this$h$t[0],
      e = _this$h$t[1];
    return n(this.p, t) && n(this.k, e);
  };
  function s(t, e, n) {
    this.h = new l(e.length, t.length), this.p = t, this.k = e, this.m = n;
  }
  return s;
}();
window.init = function (t, e, n) {
  if (n === void 0) {
    n = !1;
  }
  !function (t, e, n, u, o, l) {
    var d = i(t.length * e.length, function () {
        var t = document.createElement("td");
        return t.classList.add("c"), t;
      }),
      h = new s(t, e, d);
    if (t.forEach(function (t, i) {
      var c = document.createElement("tr");
      e.forEach(function (t, n) {
        var s = d[i * e.length + n];
        s.classList.add("e"), s.addEventListener("click", function () {
          if (h.l(i, n), l) {
            var _h$h$t = h.h.t(),
              _t2 = _h$h$t[0],
              _e = _h$h$t[1];
            r(_t2, u, _e, o, !0);
          } else h.g() && alert("Hooray");
        }), c.appendChild(s);
      }), n.appendChild(c);
    }), r(t, u, e, o, l), l) {
      var _t3 = document.getElementById("b"),
        _e2 = document.getElementById("l"),
        _n2 = document.getElementById("v"),
        _i3 = document.getElementById("b");
      _e2.addEventListener("keyup", function () {
        (function (t) {
          var e = new URL("/valid_name", c);
          return e.searchParams.append("name", t), fetch(e).then(function (t) {
            return t.text();
          });
        })(this.value).then(function (t) {
          _i3.disabled = !!t, _n2.textContent = t;
        });
      }), _t3.addEventListener("click", function () {
        !function (t, e) {
          fetch(new URL("/add_new", c), {
            method: "POST",
            body: JSON.stringify({
              name: t,
              data: e
  ...
  }(t, e, document.getElementById("n"), document.getElementById("s"), document.getElementById("t"), n);
};
}();
/******/ })()
;